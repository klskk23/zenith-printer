...
export const copy = {
  ...
  dataSources: {
    ...
    fromAddress: (url: string): string => `来自 ${url}`,
    freshJustNow: '刚刚刷新',
    ...
    addHttp: '从地址接入',
    httpTitle: '从一个地址读取这张表',
    httpExplain: '对方需要回一个 JSON：{"columns": [...], "rows": [...]}，所有值都是字符串。',
    httpUrl: '地址',
    httpUrlPlaceholder: 'http://主机:端口/api/rows?…',
    httpHeaders: '请求头（每行一个 名称: 值）',
    httpHeadersHint: '凭证写在这里。存下之后不会再回显，只显示名称。',
    httpCreate: '接入',
    httpCreated: '已接入。还没有取过数据，点「刷新」取一次。',
    refresh: '刷新',
    refreshing: '刷新中…',
